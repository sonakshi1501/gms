...
<div class="container animated slideInUp " style="margin-bottom:1%">
    <div class="row">
        <div class="container">
            <div class="col-md-12 table-responsive" style="padding:0%;background-color:;margin:0px;padding-top:10%;height:100%;padding-bottom:10%;">
                <center>
                    
                    <img src="/gms/img/SEARCH.png" class="img-fluid hidden-sm-down" width="25%">
                    ...
                    <form action="/gms/search/" method="get">
                        <div class="container">
                            <div class="col-md-8 col-sm-offset-2">
                                <input type="text" placeholder="Search Game or Type Category..." name="search_text">
                                <button class="btn btn btn-info" type="submit" style="margin-left:0px;margin-top:5%;" name="submit" value="submit"><i class="fa fa-search animated fadeInDown" aria-hidden="true"></i> Search</button>
                            </div>
                        </div>
                    </form>
                    <br>
