...
//echo $b;
	...
	$query ="SELECT GC_NAME FROM games_cat WHERE GC_ID = $b";
...
error_reporting(0);
	if(!empty($_POST['submit'])){
        ...
        {
            $query = "UPDATE games_cat SET GC_NAME='$bc_name' WHERE GC_ID=$id";
            if (mysqli_query($db, $query)) {
                            $msg="Game Category Succesfully Updated";
                         ...
                         //echo "Error updating record: " . mysqli_error($db);
                          ...
                          <a href='/gms/editcat/".$id."'><button>Go Back</button></a> 
                          </div></center>";
                          echo "<center>";
...
<head>
    ...
    <title>Edit Game Category | vGMS</title>
...
<div class="container animated fadeInUp">
    <div class="row">
        <div class="col-md-6" style="background-color:;">
            <h4 style="margin-top:0%;margin-bottom:0px"><i class="fa fa-edit animated fadeInDown" aria-hidden="true"></i> Edit Games Category</h4>
        ...
        <div class="col-md-12" style="">
            <ul class="list-inline" style="margin:0px">
                <li class="list-inline-item">
                    <a href=" /gms/showcat" class="btn btn-default btn-sm" style="margin:0px;"><i class="fa fa-arrow-circle-left" aria-hidden="true"></i> Back to Manage Games Category</a>
                </li>
            </ul>
        </div>
    </div>    
        ...
        <div class="col-md-12 " style="margin-top:0%;"> 
           <div class="container z-depth-3" style="background-color:#fafafa">
                <div class="row" style="">
                    <div class="col-md-5 z-depth-3" style="padding:0%;background-color:#0099CC;color:white">
                        <img src="/gms/img/bg.jpg" class="img-fluid" width="100%">
                         <center>
                            ...
                            <br>
                            <br>
                            <h5 class="h5-responsive" style="margin:1%">Video Game Management System</h5>
                    ...
                    <form method="post" action="/gms/editcat/<?php echo $b;?>"   style="background-color:;padding:4%">
                            <div class="container">
                                
                                <div class="row">
                                    <div class="col-md-10 col-md-offset-1" style="background-color:">
                                        <form-group>
                                            <label class="disabled" for="fbc" style="margin:0px">Game Category ID</label>
                                ...
                                <div class="row">
                                    <div class="col-md-10 col-md-offset-1" style="background-color:;margin-top:2%">
                                       <button class="btn btn-info" type="submit" style="margin-left:0px;margin-top:5%;" name="submit" value="Save Book Category">Save Games Category</button>
                                    </div>
                                </div>
