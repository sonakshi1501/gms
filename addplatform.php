...
<?php
	if($_POST){
		...
		$query ="INSERT INTO game_type (GT_NAME) VALUES ('$bc_name')";
                 if (mysqli_query($db, $query)) {
                            $msg="New Games Platform Successfully Added";
                         ...
                         //echo "Error updating record: " . mysqli_error($db);
                          ...
                          <a href='/gms/addplatform'><button>Go Back</button></a> 
                          </div></center>";
                            echo "<center>";
...
<div class="container animated fadeInUp">
    <div class="row">
        <div class="col-md-6" style="background-color:;">
            <h4 style="margin-top:0%;margin-bottom:0px"><i class="fa fa-calendar-plus-o animated fadeInDown" aria-hidden="true"></i> Add Platform Category</h4>
        ...
        <div class="col-md-12" style="">
            <ul class="list-inline" style="margin:0px">
                <li class="list-inline-item">
                    <a href="/gms/showcat" class="btn btn-default btn-sm" style="margin:0px;"><i class="fa fa-arrow-circle-left" aria-hidden="true"></i> Back to Manage Games Platform</a>
                </li>
            </ul>
        </div>
    </div>
        ...
        <div class="col-md-12" style="background-color:">
            <div class="container z-depth-3" style="background-color:#fafafa ">
                <div class="row">
                    ...
                    <div class="col-md-5 z-depth-2  waves-effect" style="padding:0px;background-color:#fafafa;color:whte">
                    ...
                    <div class="col-md-7" style="background-color:#fafafa ">
                        ...
                        <div class="container">
                            <form action="/gms/addplatform" method="post" style="background-color:;padding:0%">
                            <div class="row">
                                <div class="col-md-12">
                                    <form-group>
                                            <label style="">Game Platform Name</label>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <button class="btn btn btn-info" type="submit" style="margin-left:0px;margin-top:5%;" name="submit">Save Game Platform</button>
                                </div>
                            </div>
                            </form>
                        </div>
