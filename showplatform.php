            ...
            <table class="table table-striped table-hover ">
                    ...
                    <?php 
                        ...
                        while($row = $result->fetch_assoc()){
                            ...
                            $output ='<tr>';
                            $output .='<td>'.$row['GT_NAME'].'</td>';
                            $output .='<td class="no-print"><a style="margin:0px" href="/gms/editplatform/'.$row['GT_ID'].'" class="btn btn-warning btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</a></td>';
                            $output .='<td class="no-print"><a style="margin:0px" onclick="pop()" href="/gms/delete_platform/'.$row['GT_ID'].'" class="btn btn-danger btn-sm"><i class="fa fa-remove" aria-hidden="true"></i> Delete</a></td>';
                            $output .='</tr>';
