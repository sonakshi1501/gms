<?php
    ...
    $query ="SELECT GC_NAME,GC_ID FROM games_cat order by GC_TIME DESC";
	//Get results
...
<head>
    ...
    <title>Manage Game Category | vGMS</title>
...
<div class="container animated fadeInUp">
    <div class="row">
        <div class="col-md-6" style="background-color:">
            <h4 style="margin-top:0%;margin-bottom:0px"><i class="fa fa-puzzle-piece animated fadeInDown" aria-hidden="true"></i> Manage Gamess Category</h4>
    ...
    <div class="row">
        <div class="col-md-12">
            <ul class="list-inline" style="margin:0px">
                ...
                <li class="list-inline-item">
                    <a href="/gms/addCat" class="btn-sm btn btn-info no-print"><i class="fa fa-plus-square" aria-hidden="true"></i>&nbsp;Add Game Category</a>
                </li>
            </ul>
        </div>
    </div>
            ...
            <table class="table table-striped table-hover ">
                    ...
                    <?php 
                        ...
                        while($row = $result->fetch_assoc()){
                            ...
                            $output ='<tr>';
                            $output .='<td>'.$row['GC_NAME'].'</td>';
                            $output .='<td class="no-print"><a style="margin:0px" href="/gms/editcat/'.$row['GC_ID'].'" class="btn btn-warning btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</a></td>';
                            $output .='<td class="no-print"><a style="margin:0px" onclick="pop()" href="/gms/delete_cat/'.$row['GC_ID'].'" class="btn btn-danger btn-sm"><i class="fa fa-remove" aria-hidden="true"></i> Delete</a></td>';
                            $output .='</tr>';
