...
$sql = "DELETE FROM games_cat WHERE GC_ID=$a";

if (mysqli_query($db, $sql)) {
    $msg="Game Category has been Delected Successfully";
   ...
   <center> Error deleting record!! " // mysqli_error($db)
    ...
    <a href='/gms/showcat'><button>Go Back</button></a>
    </center>
...
<html>
    <head>
    <title>Deleating Games Category...</title>
        <link rel="shortcut icon" href="/gms/img/fav.png" type="image/x-icon" />
    </head>
    
    <body style="background-color:#eceff1 ">
        
        <footer><br><br><br><br><br><br><hr><center>&copy;Video Games Management System</center></footer>
    </body>
</html>
